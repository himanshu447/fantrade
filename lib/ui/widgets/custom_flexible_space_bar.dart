...
class CustomFlexibleSpaceBar extends StatefulWidget {
  ...
  static Widget createSettings({
    ...
    return CustomFlexibleSpaceBarSettings(
...
class _CustomFlexibleSpaceBarState extends State<CustomFlexibleSpaceBar> {
  ...
  double _getCollapsePadding(double t, CustomFlexibleSpaceBarSettings settings) {
    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        if (widget.title != null) {
          ...
          if (opacity > 0.0) {
            TextStyle titleStyle = theme.primaryTextTheme.headline1!;
...
/// Provides sizing and opacity information to a [CustomFlexibleSpaceBar].
///
/// See also:
///
///  * [CustomFlexibleSpaceBar] which creates a flexible space bar.
class CustomFlexibleSpaceBarSettings extends InheritedWidget {
  ...
  /// [CustomFlexibleSpaceBar] widget in its tree for the settings to take affect.
  ///
  ...
  /// Minimum height of the resulting [CustomFlexibleSpaceBar] when fully collapsed.
  final double minExtent;

  /// Maximum height of the resulting [CustomFlexibleSpaceBar] when fully expanded.
  final double maxExtent;

  /// If the [CustomFlexibleSpaceBar.title] or the [CustomFlexibleSpaceBar.background] is
